...
- **Secrets** — API keys, VM passwords, IRIS admin password, etc. live in `SOC-Automation-Project.md` at project root, which is gitignored. See [vault/runbooks/secrets-management.md](vault/runbooks/secrets-management.md).
